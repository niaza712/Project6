...
function drawExpression(detections, x, y, textYSpace) {
  if (detections.length > 0) {//If at least 1 face is detected: もし1つ以上の顔が検知されていたら
...
{console.log(localStorage.getItem("happy1")); 
       
  } if (angry > 0.8) {
    dominantExpression = "anger";
    dominantExpressionDetected = true;
    document.getElementById("myDiv").innerHTML = `
      ;
    ...
    text(dominantExpression + ": " + nf(detections[0].expressions[dominantExpression] * 100, 2, 2) + "%", x, y);
  }
